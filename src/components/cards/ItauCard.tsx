...
export function ItauCard({ number, name, expiry, cvv, isFlipped }: CardProps) {
  const displayCardNumber = number || "5458 3617 2290 4471";
...
function ItauLogo({ small }: { small?: boolean }) {
  return (
    <div style={{ position: "relative", width: small ? 32 : 46, height: small ? 32 : 46 }}>
      <Image
        src="/itau.webp"
        alt="Itaú Logo"
        fill
