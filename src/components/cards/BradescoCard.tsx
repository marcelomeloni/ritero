...
export function BradescoCard({ number, name, expiry, cvv, isFlipped }: CardProps) {
  const displayCardNumber = number || "5455 0059 4123 8807";
...
function BradescoLogo({ small }: { small?: boolean }) {
  return (
