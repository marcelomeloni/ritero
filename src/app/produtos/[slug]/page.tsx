...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const cafeName = cafe.notas.split(",")[0] || cafe.notas;

  return {
    title: `${cafeName} — Café Especial`,
    description: `Compre o café especial ${cafeName}, cultivado na região de ${cafe.regiao}. Notas de ${cafe.notas}.`,
  };
}
