...
export const metadata: Metadata = {
  title: "Nossos Cafés Especiais | Ritero",
  description:
    "Explore nossa seleção de cafés especiais brasileiros. Perfil sensorial único, notas frutadas, doces e achocolatadas. Escolha sua moagem ideal. Compre café especial online.",
  keywords: [
    "cafés especiais",
  ...
  alternates: {
    canonical: "https://ritero.com.br/cafes",
  },
  openGraph: {
    title: "Nossos Cafés Especiais | Ritero",
    description: "Explore nossa seleção de cafés especiais brasileiros. Perfil sensorial único, notas frutadas, doces e achocolatadas.",
    url: "https://ritero.com.br/cafes",
    siteName: "Ritero",
    locale: "pt_BR",
    type: "website",
...
export default function Produtos() {
  const schemaItemList = {
    ...
    "itemListElement": CAFES.map((cafe, index) => ({
      "@type": "ListItem",
      "position": index + 1,
      "url": `https://ritero.com.br/cafes/${cafe.slug}`,
      "name": cafe.notas.split(',')[0].trim() || cafe.notas
    }))
  };
            ...
            >
              ...
              >
                ...
                <div className="mt-5 flex flex-col gap-[5px]">
                  {[
                    { label: "SCA", value: cafe.pontuacao ? `${cafe.pontuacao} pts` : "-" },
